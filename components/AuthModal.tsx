...
import { auth } from "@/lib/firebase" // Você precisará criar este arquivo
  ...
  const handleGoogleAuth = async (isRegistration = false) => {
    try {
      ...
      if (result.user && result.user.email) {
        // Chamar a API para login/registro social
        ...
        toast({
          title: isRegistration ? "Registro com Google concluído" : "Login com Google concluído",
      ...
      toast({
        ...
        description: "Não foi possível autenticar com Google. Tente novamente.",
        variant: "destructive",
      })
    } finally {
